...
function Essence() {
  ...
  return (
    <section id="essencia" className="relative bg-background">
      ...
      {/* Nossos Valores */}
      <div className="btl-values-section relative isolate overflow-hidden bg-primary text-primary-foreground">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 md:py-24">
          ...
          <div className="btl-values-grid grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {[
              ...
              <article
                key={v.title}
                className="btl-value-card group flex min-h-[210px] flex-col items-center justify-center rounded-2xl border border-white/10 bg-white/[0.045] px-5 py-7 text-center backdrop-blur-sm transition duration-300 hover:-translate-y-1 hover:border-[var(--brand-amber)]/55 hover:bg-white/[0.075]"
              >
                <div className="btl-value-icon flex h-16 w-16 items-center justify-center rounded-full border border-[var(--brand-amber)]/45 bg-[var(--brand-amber)]/10 text-[var(--brand-amber)] transition duration-300 group-hover:scale-105 group-hover:bg-[var(--brand-amber)]/15">
    ...
    <footer className="relative isolate overflow-hidden border-t border-white/10 bg-black text-white">
      ...
      <div className="relative z-20 mx-auto grid max-w-7xl gap-8 px-6 py-10 md:gap-12 md:py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white">
            <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-white" /> (47) 3620-0917</li>
      ...
      <div className="relative z-20 border-t border-white/10 backdrop-blur-sm">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-6 py-4 text-xs text-white/70 md:flex-row md:py-6">
          <p>Copyright © 2026 BTL Transportes. Todos os direitos reservados.</p>
...
function BrazilFiliais() {
  const allPins = [
    ...
    { city: "São Marcos", uf: "RS", lat: -28.9706, lng: -51.0669 },
    { city: "Camaçari", uf: "BA", lat: -12.6975, lng: -38.3242 },
    { city: "Alfredo Chaves", uf: "ES", lat: -20.6367, lng: -40.7508 },
  ];
